...
public interface UserDAO {
    ...
    @Query("SELECT * FROM "+ByteDatabase.USER_TABLE+" ORDER BY username")
    LiveData<List<User>> getAllUsers();

    @Query("DELETE from "+ ByteDatabase.USER_TABLE)
    void deleteALL();

    @Query("SELECT * from "+ByteDatabase.USER_TABLE+" WHERE username == :username")
