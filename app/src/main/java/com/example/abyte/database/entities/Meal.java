...
public class Meal {
    ...
    //to get ingredients and measurements easier
    public List<String> getListOfBothIngredientsAndMeasurements(){
        List<String> list= new ArrayList<>();
        for (int i=1;i<=20;i++){
            try{
                Field ingredientField= this.getClass().getDeclaredField("strIngredient"+i);
                Field measurementField= this.getClass().getDeclaredField("strMeasure"+i);
                ingredientField.setAccessible(true);
                measurementField.setAccessible(true);
                String ingredient=(String)ingredientField.get(this);
                String measure=(String)measurementField.get(this);
                ...
                Log.i(MainActivity.TAG,"Problem reading ingredients and measurements field");
            }
        }
        return list;
    }
